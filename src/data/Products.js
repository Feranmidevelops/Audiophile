...
Discover clear, more natural sounding highs than the competition with ZX9’s signature planar diaphragm tweeter. Equally important is its powerful room-sharing bass courtesy of a 6.5" aluminum alloy bass unit. You’ll be able to enjoy equal sound quality whether in a large room or small den. Furthermore, you will experience new sensations from old songs since it can respond to even the subtle waveforms.`,
    ...
    image: '/zx9.png',
    gallery: ['/zx9shelf.png', '/zx9close.png', '/zx9twins.png'],
    relatedProducts: [
      { slug: 'zx7-speaker', name: 'ZX7 SPEAKER', image: '/zx7full.png' },
      { slug: 'xx99-mark-i-headphones', name: 'XX99 MARK I', image: '/techxx99mark1.png' },
      { slug: 'xx59-headphones', name: 'XX59', image: '/whitexx59.png' }
    ]
  },
  {
    slug: 'zx7-speaker',
...
The ZX7 speaker is the perfect blend of stylish design and high performance. It houses an encased MDF wooden enclosure which minimises acoustic resonance. Dual connectivity allows pairing through bluetooth or traditional optical and RCA input. Switch input sources and control volume at your finger tips with the included wireless remote. This versatile speaker is equipped to deliver an authentic listening experience.`,
    ...
    image: '/zx7full.png',
    gallery: ['/zx7speaker.png', '/zx9close.png', '/zx9twins.png'],
    relatedProducts: [
      { slug: 'zx9-speaker', name: 'ZX9 SPEAKER', image: '/zx9.png' },
      { slug: 'xx99-mark-i-headphones', name: 'XX99 MARK I', image: '/techxx99mark1.png' },
      { slug: 'xx59-headphones', name: 'XX59', image: '/whitexx59.png' }
    ]
  },
...
The advanced Active Noise Cancellation with built-in equalizer allow you to experience your audio world on your terms. It lets you enjoy your audio in peace, but quickly interact with your surroundings when you need to. Combined with Bluetooth 5.0 compliant connectivity and 17 hour battery life, the XX99 Mark II headphones gives you superior sound, cutting-edge technology, and a modern design aesthetic.`,
    ...
    image: '/heroheadphones.png',
    gallery: ['/man2.png', '/Bitmap(3).png', '/holdxx59.png'],
    relatedProducts: [
      { slug: 'xx99-mark-i-headphones', name: 'XX99 MARK I', image: '/techxx99mark1.png' },
      { slug: 'xx59-headphones', name: 'XX59', image: '/whitexx59.png' },
      { slug: 'zx9-speaker', name: 'ZX9 SPEAKER', image: '/zx9.png' }
...
From the handcrafted microfiber ear cushions to the robust metal headband with inner damping element, the components work together to deliver comfort and uncompromising sound. Its closed-back design delivers up to 27 dB of passive noise cancellation, reducing resonance by reflecting sound to a dedicated absorber. For connectivity, a specially tuned cable is included with a balanced gold connector.`,
    ...
    gallery: ['/aestheticsshot.png', '/Bitmap(3).png', '/lightBitmap(2).png'],
    relatedProducts: [
      { slug: 'xx99-mark-ii-headphones', name: 'XX99 MARK II', image: '/heroheadphones.png' },
      { slug: 'xx59-headphones', name: 'XX59', image: '/whitexx59.png' },
      { slug: 'zx9-speaker', name: 'ZX9 SPEAKER', image: '/zx9.png' }
    ]
  },
...
More than a simple pair of headphones, this headset features a pair of built-in microphones for clear, hands-free calling when paired with a compatible smartphone. Controlling music and calls is also intuitive thanks to easy-access touch buttons on the earcups. Regardless of how you use the XX59 headphones, you can do so all day thanks to an impressive 30-hour battery life that can be rapidly recharged via USB-C.`,
    ...
    image: '/whitexx59.png',
    gallery: ['/xx59woman.png', '/holdxx59.png', '/bookxx59.png'],
    relatedProducts: [
      { slug: 'xx99-mark-ii-headphones', name: 'XX99 MARK II', image: '/heroheadphones.png' },
      { slug: 'xx99-mark-i-headphones', name: 'XX99 MARK I', image: '/techxx99mark1.png' },
      { slug: 'zx9-speaker', name: 'ZX9 SPEAKER', image: '/zx9.png' }
...
The YX1 Wireless Earphones features customizable controls for volume, music, calls, and voice assistants built into both earbuds. The new 7-hour battery life can be extended up to 28 hours with the charging case, giving you uninterrupted play time. Exquisite craftsmanship with a splash resistant design now available in an all new white and grey color scheme as well as the popular classic black.`,
    ...
    image: '/yx1earphones.png',
    gallery: ['/earphones.png', '/bookxx59.png', '/zx9twins.png'],
    relatedProducts: [
      { slug: 'xx99-mark-i-headphones', name: 'XX99 MARK I', image: '/techxx99mark1.png' },
      { slug: 'xx59-headphones', name: 'XX59', image: '/whitexx59.png' },
      { slug: 'zx9-speaker', name: 'ZX9 SPEAKER', image: '/zx9.png' }
